document.addEventListener("DOMContentLoaded", () => {
    ...
    const patterns = {
      email: /^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|icloud\.com|protonmail\.com)$/i,
      name: /^[a-zA-Z\s'-]{2,}$/,
      password: {
        minLength: 8,
        hasNumber: /[0-9]/,
      ...
      signupForm.addEventListener("submit", (event) => {
        ...
        if (isValid) {
          const userData = {
            ...
            newsletter: newsletterCheck?.checked || false
          }
          ...
          fetch("http://localhost:5000/api/auth/register", {
            ...
            .then(data => {
              if (data.token) {
                ...
                // ✅ Show success modal (already in your code)
                ...
                // ✅ Redirect to login or dashboard after few seconds (optional)
                setTimeout(() => {
